...
{
    /// <summary>
    /// BlueStabilisers is a subsystem controller for the TARDIS console's Blue stabilisers.
    /// It manages if the tardis has flight events or not.
    /// </summary>

    public class BlueStabilisers : TARDISConsoleController
    {
