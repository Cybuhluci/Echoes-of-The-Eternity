...
{
    /// <summary>
    /// Refueller is a subsystem controller for the TARDIS console's Refueller system.
    /// It manages the refuelling operations of the TARDIS.
    /// </summary>

    public class FastReturn : TARDISConsoleController
    {
