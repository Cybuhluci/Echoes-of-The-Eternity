...
public class PlayerColliderInteract : MonoBehaviour
{
    ...
    void HandleInteractionInput()
    {
        if (currentInteractable != null)
        {
            ...
            {
                currentInteractable.RegularInteract();
            }
            else if (playerInput.actions["Interact"].activeControl != null && Keyboard.current.leftCtrlKey.isPressed)
            {
                currentInteractable.ModifierInteract();
            }
        }
    }
